...
test:
	@echo "Sending a test Pub/Sub message to the 'store-order-data' function..."
	@now=$$(date -u +"%Y-%m-%dT%H:%M:%SZ"); \
	payload=$$(printf '{"orderId":"MAKE-TEST-%s","totalOrder":125.75,"paymentType":"credit_card","deliveryType":"standard"}' "$$now"); \
